...
2. `02_solution_landscape.md` — hiểu LangGraph, MLflow, Git và Harness Hub giải quyết phần nào.
3. `03_build_decisions.md` — chốt phần nào Borrow, Extend hoặc Build.
...
- Thành phần nào được Borrow và thành phần nào Harness Hub phải Build?
